...
public class TrendActivity extends BaseSherlockFragmentActivity {
...
//                    }
    ...
    private void fillData(List<Trend> trends) {
        if (trends != null) {
            ...
            TrendAdapter adapter = new TrendAdapter(this);
            ...
            listView.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                    ...
                    Gh4Application.get(TrendActivity.this).openRepositoryInfoActivity(TrendActivity.this,
