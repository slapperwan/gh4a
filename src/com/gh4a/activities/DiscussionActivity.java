...
public class DiscussionActivity extends BaseSherlockFragmentActivity {
...
//                    }
    ...
    private void fillData(List<Feed> result) {
        ...
        if (result != null) {
            DiscussionCommentFeedAdapter adapter = new DiscussionCommentFeedAdapter(DiscussionActivity.this);
